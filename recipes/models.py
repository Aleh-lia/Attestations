...
class Recipes(models.Model):
    ...
    photo = models.ImageField(upload_to="media/%Y/%m/%d/", default=None,
    ...
    author = models.ForeignKey(get_user_model(), on_delete=models.SET_NULL, related_name='author', verbose_name="Автор", null=True, default=None)
...
#     name = models.CharField(max_length=100, db_index=True, verbose_name="Никнейм")
#     slug = models.SlugField(max_length=255, unique=True, db_index=True)
